...
require './lib/pix/cobrancas/json/bacen'

RSpec.describe Pix::Cobrancas::Json::Bacen do
  describe 'gera json' do
    ...
    it 'location.id presente' do
      location = described_class.new(cobranca).json['loc']
    ...
    context 'cobranca com vencimento' do
      ...
      it 'informacoes adicionais' do
        ...
        json = described_class.new(cobranca).json['infoAdicionais']
